...
const CarouselItem = React.forwardRef((_a, ref) => {
    ...
    return (<div ref={ref} role="group" aria-roledescription="slide" className={cn("min-w-0 shrink-0 grow-0 basis-full cursor-pointer", orientation === "horizontal" ? "pl-4" : "pt-4", className)} {...props}/>);
});
