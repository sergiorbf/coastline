        ...
        <div>
          <section>
                  ...
                  <Popover>
                    ...
                    <PopoverContent className="w-96 p-4 shadow-md rounded-lg">
                      ...
                      <div className="mt-4">
                        ...
                        {popularDestinations.map((destination) => (<Button key={destination.city} type="button" variant="ghost" className="w-full flex justify-start gap-4 p-3 rounded-md" onClick={() => handleDestinationClick(destination.city)}>
                            <MapPin />
                        ...
                        <Tabs defaultValue="calendar">
                          ...
                          <TabsContent value="calendar">
                            <CardContent className="grid grid-cols-2 gap-4">
                              <FormField control={form.control} name="dateFrom" render={({ field }) => (<FormItem>
                                    <FormControl>
                                      <Calendar mode="single" {...field}/>
                                    </FormControl>
                                  </FormItem>)}/>
                              <FormField control={form.control} name="dateTo" render={({ field }) => (<FormItem>
                                    <FormControl>
                                      <Calendar mode="single" {...field}/>
                                    </FormControl>
                                  </FormItem>)}/>
            ...
            align: "start",
                                  ...
                                  <CarouselContent>
                                    {monthsOfYear.map((month, index) => (<CarouselItem key={index} className="md:basis-1/2 lg:basis-1/4">
                                        <div className="p-1">
                                          <Card>
