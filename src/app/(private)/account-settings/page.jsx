...
export default function AccountSettings() {
    return (<section className="p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {settingsOptions.map((option, index) => (<Card key={index} className="border shadow-md hover:shadow-lg transition-shadow flex flex-col h-full">
            ...
            <CardFooter className="p-4 mt-auto flex justify-between items-center">
              <LinkButton href={option.link} buttonText={option.buttonText}/>
            </CardFooter>
          </Card>))}
      </div>
    </section>);
