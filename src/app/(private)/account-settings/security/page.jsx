          ...
          <CardContent>
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(handleOnSubmit)} className="mt-6 flex flex-col w-full gap-5">
                <FormField name="currentPassword" control={form.control} render={({ field }) => (<FormItem>
                ...
                <FormField name="newPassword" control={form.control} render={({ field }) => (<FormItem>
                ...
                <FormField name="confirmPassword" control={form.control} render={({ field }) => (<FormItem>
            ...
            <div className="mt-8">
              ...
              {is2FAEnabled && (<p className="text-sm text-green-600 mt-2">
