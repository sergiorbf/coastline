...
export default function Payments() {
    ...
    function handleAddPaymentMethod(data) {
      ...
      <div className="p-8 min-h-screen w-full">
        ...
        <Card className="w-full max-w-2xl mx-auto shadow-md rounded-lg">
          <CardContent>
            ...
            <div className="mb-6">
              <Button onClick={handleOpenDialog} className="px-4 py-2">
                Add Payment Method
              </Button>
            </div>
          </CardContent>
        ...
        <DialogContent>
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(handleAddPaymentMethod)} className="space-y-4">
              <FormField name="cardholderName" render={({ field }) => (<FormItem>
              ...
              <FormField name="cardNumber" render={({ field }) => (<FormItem>
              ...
              <div className="grid grid-cols-2 gap-4">
                <FormField name="expirationDate" render={({ field }) => (<FormItem>
                ...
                <FormField name="cvv" render={({ field }) => (<FormItem>
