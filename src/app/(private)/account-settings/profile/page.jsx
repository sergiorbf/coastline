              ...
              <form onSubmit={form.handleSubmit(handleOnSubmit)} className="mt-6 flex flex-col w-full gap-5">
                ...
                <div>
                  ...
                  <div className="flex gap-4 py-1">
                    <FormField control={form.control} name="dateOfBirth.month" render={({ field }) => (<FormItem className="flex-1">
                          <FormControl>
                            <Select onValueChange={(value) => field.onChange(value)} defaultValue={field.value}>
                              ...
                              <SelectContent>
                                {monthsOfYear.map((month) => (<SelectItem key={month} value={month}>
                                    {month}
                                  </SelectItem>))}
                              </SelectContent>
                            </Select>
                    ...
                    <FormField control={form.control} name="dateOfBirth.day" render={({ field }) => (<FormItem className="flex-1">
                          <FormControl>
                            <Input type="text" placeholder="Day" {...field}/>
                          </FormControl>
                        </FormItem>)}/>
                    <FormField control={form.control} name="dateOfBirth.year" render={({ field }) => (<FormItem className="flex-1">
                          <FormControl>
                ...
                <div className="flex flex-col gap-3 lg:grid lg:grid-cols-form pt-5">
                  <FormLabel htmlFor="photo" className="text-sm font-medium">
                    Your photo
                ...
                <FormField control={form.control} name="address2" render={({ field }) => (<FormItem>
                      <FormLabel>
                        Apt, Suite, Floor
                      </FormLabel>
                      <FormControl>
                ...
                <div className="flex gap-4 py-1 w-full">
                  <div className="flex-1">
                    <FormField control={form.control} name="city" render={({ field }) => (<FormItem>
                          ...
                          <FormControl>
                            <Input type="text" placeholder="City" className="w-full" {...field}/>
                          </FormControl>
                        </FormItem>)}/>
                  </div>
                  <div className="flex-1">
                    <FormField control={form.control} name="state" render={({ field }) => (<FormItem>
                          ...
                          <FormControl>
                            <Input type="text" placeholder="State / Province / County / Region" className="w-full" {...field}/>
                          </FormControl>
                        </FormItem>)}/>
                  </div>
                </div>
